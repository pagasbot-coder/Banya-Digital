...
| Роль | Шрифт | Fallback |
|------|-------|----------|
| Заголовки (`font-heading`) | **Calibri** | Carlito, Segoe UI, Helvetica Neue, Arial |
| UI / body (`font-sans`) | **Calibri** | Carlito, Segoe UI, Helvetica Neue, Arial |

Стек: `Calibri, 'Carlito', 'Segoe UI', 'Helvetica Neue', Arial, sans-serif` — системный на Windows; на Mac/Linux — Carlito или Segoe UI. Google Fonts (Cardo/Inter) не подключаем.
