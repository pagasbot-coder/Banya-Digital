...
**Prod retest (2026-05-30, после `vercel --prod`, commit `7af2e2e`):**

| Сценарий | POST | UI | KPI |
|----------|------|-----|-----|
| Prod: Хамам + 3 000 ₽ (без услуги) | **200** | «Выручка сохранена.», без error boundary | Факт 917 022 → 920 022 ₽ |
