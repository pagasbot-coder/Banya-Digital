...
def build():
    ...
    # 11 Cost expertise — plain copy + example
    s = prs.slides.add_slide(blank)
    add_bg(s)
    ...
    write_block(
        ...
        *L,
        [
            card_header("Из чего складывается цена"),
            *labeled(
                "Цена завода",
                "Сколько стоит товар у производителя до отправки",
                gap=8,
            ),
            *labeled(
                "Доставка",
                "Море или самолёт, экспедитор, довоз до склада в Киришах",
                gap=8,
            ),
            *labeled("Таможня", "Пошлина, налог, услуги брокера", gap=8),
            *labeled("Запас", "Брак, пересорт, скачок курса", gap=8),
            *labeled(
                "На складе",
                "Сложили строки — получили реальную себестоимость единицы",
                gap=8,
            ),
    ...
    write_block(
        ...
        *R,
        [
            card_header("Пример (учебный, не оферта)"),
            *labeled("Цена завода", "8 ₽ за флакон", gap=8),
            *labeled("Доставка", "3 ₽", gap=8),
            *labeled("Таможня", "2 ₽", gap=8),
            *labeled("Запас", "1 ₽", gap=8),
            *labeled("На складе", "14 ₽ — отсюда прайс и маржа", gap=8),
            *labeled(
                "Правило",
                "Сравниваю заводы по цене у производителя; доставку считаю отдельно",
                gap=0,
            ),
        ],
    )
